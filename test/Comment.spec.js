...
describe('Change user roles', () => {
  ...
  it('it should not create a comment without auth', (done) => {
    chai
      .request(app)
      .post(`/api/v1/users/requests/${requestId}/comments`)
      .send(commentOne)
      .end((err, res) => {
  ...
  it('it should not create a comment for a request that does not exist', (done) => {
    chai
      .request(app)
      .post('/api/v1/users/requests/1000/comments')
      .set('Authorization', `Bearer ${requesterToken}`)
      .send(commentOne)
      .end((err, res) => {
  ...
  it('it should return error on invalid params', (done) => {
    chai
      .request(app)
      .post('/api/v1/users/requests/100f0/comments')
      .set('Authorization', `Bearer ${requesterToken}`)
      .send(commentOne)
      .end((err, res) => {
        res.should.have.status(400);
  ...
  it('it should be able to edit comment if owner', (done) => {
    chai
      .request(app)
      .patch(`/api/v1/users/requests/${requestId}/comments/${commentId}`)
      .set('Authorization', `Bearer ${requesterToken}`)
      .send(commentTwo)
      .end((err, res) => {
        res.should.have.status(200);
  ...
  it('it should not be able to edit comment it does not exist', (done) => {
    chai
      .request(app)
      .patch(`/api/v1/users/requests/${requestId}/comments/1000`)
      .set('Authorization', `Bearer ${travelAdminToken}`)
      .send(commentTwo)
      .end((err, res) => {
        res.should.have.status(404);
  ...
  it('it should not be able to edit comment it does not exist', (done) => {
    chai
      .request(app)
      .patch(`/api/v1/users/requests/${requestId}/comments/1000ere`)
      .set('Authorization', `Bearer ${travelAdminToken}`)
      .send(commentTwo)
      .end((err, res) => {
        res.should.have.status(400);
  ...
  it('it should be able to get comments of a your own request', (done) => {
    chai
      .request(app)
      .get(`/api/v1/users/requests/${requestId}/comments`)
      .set('Authorization', `Bearer ${requesterToken}`)
      .end((err, res) => {
        res.should.have.status(200);
        done();
